...
/* MGT Unicorn Suite: MSYS2 UCRT64 provides a POSIX-compatible <dirent.h>
   with the DIR type, which HTFile.h declares unconditionally. Include
   it here so the Win32 branch has DIR available without patching
   HTFile.h itself. */
#include <dirent.h>
