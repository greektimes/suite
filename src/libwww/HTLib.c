 ...
 * "http://www[.]w3[.]org:8001/", a W3C-hosted WAIS-over-HTTP gateway.
 * The host is written defanged, with bracketed dots, so that a plain
 * grep for a third-party URL over this tree comes back clean. The
